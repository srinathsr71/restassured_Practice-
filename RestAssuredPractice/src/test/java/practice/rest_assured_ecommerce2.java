...
public class rest_assured_ecommerce2 {
	...
	public void getproduct()
	{
		...
		JSONObject js=new JSONObject();
		given().auth().oauth2("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MzczOGVhYzllYjcxMzAwMTc2MmE1ZDEiLCJpYXQiOjE2Njg1MjY1NzUsImV4cCI6MTY2ODYxMjk3NX0.ZyGFo64dH_4O-G6C0UYmf3-fe05DTGW9ZI4mdaG3jz4")
		.contentType(ContentType.JSON).accept(ContentType.JSON).when().get("/products/63746195347b900017d6fde1").then().log().all();
	...
	public void update_product()
	{
		...
		RestAssured.baseURI=url;
		JSONObject js=new JSONObject();
		js.put("name", "Glass_Bottles");
		js.put("price", "1000");
		
		given().auth().oauth2("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MzczOGVhYzllYjcxMzAwMTc2MmE1ZDEiLCJpYXQiOjE2Njg1MjY1NzUsImV4cCI6MTY2ODYxMjk3NX0.ZyGFo64dH_4O-G6C0UYmf3-fe05DTGW9ZI4mdaG3jz4")
		.contentType(ContentType.JSON).accept(ContentType.JSON).when().put("/products/63746195347b900017d6fde1").then().log().all();
	...
	public void creat_order()
	{
		...
		RestAssured.baseURI=url;
		JSONObject js=new JSONObject();
		js.put("product", "6373c4a79eb713001762a663");
		js.put("quantity", 100);
		
		given().auth().oauth2("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MzczOGVhYzllYjcxMzAwMTc2MmE1ZDEiLCJpYXQiOjE2Njg1MjA5NTUsImV4cCI6MTY2ODYwNzM1NX0.cliYXNV6kTGHRnuoFusrOOka7hVvXVzWhgeaCyPJs10")
		.contentType(ContentType.JSON).accept(ContentType.JSON).body(js).when().
	...
	public void getorder_id()
	{
		...
		given().auth().oauth2("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MzczOGVhYzllYjcxMzAwMTc2MmE1ZDEiLCJpYXQiOjE2Njg1MjY1NzUsImV4cCI6MTY2ODYxMjk3NX0.ZyGFo64dH_4O-G6C0UYmf3-fe05DTGW9ZI4mdaG3jz4")
		.contentType(ContentType.JSON).accept(ContentType.JSON).when().
		post("/orders/6373c8009eb713001762a677").then().log().all();
	...
	public void update_order_id()
	{
		...
		JSONObject js=new JSONObject();
		js.put("product", "6373c8009eb713001762a677");
	...
	public void delete_order_id()
	{
		...
		given().auth().oauth2("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MzczOGVhYzllYjcxMzAwMTc2MmE1ZDEiLCJpYXQiOjE2Njg1MjY1NzUsImV4cCI6MTY2ODYxMjk3NX0.ZyGFo64dH_4O-G6C0UYmf3-fe05DTGW9ZI4mdaG3jz4")
		.contentType(ContentType.JSON).accept(ContentType.JSON).when().
		delete("/orders/6373c8009eb713001762a677").then().log().all();
